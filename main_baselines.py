...
def main(seed=2023, main_file=""):
    ...
    print(f"{global_config['baseline']}4{global_config['model']}Trainer")
    print(global_config)
    ...
    trainer.test_model(model_path='/home/aiding/multi-agent-debate-rec/baseline_checkpoints/SASrec/No_LLM/Beauty1000dense/20250523/CL4rec/normal_202505230009.pth')  # 31,36
