...
parser.add_argument('--model', type=str, default='SASrec', help='model')    # FMLPrec,SASrec,GRU4rec
# parser.add_argument('--model', type=str, default='CL4rec', help='model')
# parser.add_argument('--use_LLM', type=str2bool, default=True, help='training device')
parser.add_argument('--use_LLM', type=str2bool, default=False, help='training device')  

# dataset
# parser.add_argument('--dataset', type=str, default='Arts',  choices=['Games', 'Arts', 'MIND'], help='dataset')
parser.add_argument('--dataset', type=str, default='Games1000S3',  choices=['Games', 'Arts', 'MIND', 'Arts1000dense', 'Games1000dense', 'arts1000', 'arts1000dense'], help='dataset')
...
# parser.add_argument('--weight_decay', type=float, default=0, help='weight for L2 loss on basic models.')
parser.add_argument('--min_epochs', type=int, default=10, help='min epoch')
...
# parser.add_argument('--min_epochs', type=int, default=10, help='min epoch')
# parser.add_argument('--n_epochs', type=int, default=11, help='max epoch')

# parser.add_argument('--with_lct', type=str2bool, default=True, help='Whether use LCT to enhance RS Robustness')
parser.add_argument('--with_lct', type=str2bool, default=False, help='Whether use LCT to enhance RS Robustness')
...
parser.add_argument('--inject_persent', type=str, default='random_1', choices=['random_1', 'bandwagon_1', 'dp_1', 'rev_1'], help='type and presentage of injected user (attack file)')

# parser.add_argument('--baseline', type=str, default='CL4rec', help='presentage of injected user')
parser.add_argument('--baseline', type=str, default='CL4rec', choices=['CL4rec', 'GraphRfi', 'APR', 'ADV', 'Denoise', 'Detection', 'LLM4Dec'], help='presentage of injected user')
# parser.add_argument('--begin_adv', type=int, default=200, help='the epoch that begins to adv')
